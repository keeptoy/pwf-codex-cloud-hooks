...
- R4-B 已完成原子激活/adapter thinning；Windows 69 registered / 51 PASS / 18 honest SKIP /
  ...
  零残留门槛；R4-C beta.1 已在本地重封板为 22-entry 自校验 ZIP 和外部 bootstrap；先前的
  pre-publication Cloud seal 因 Release 边界变化而作废，新的精确字节 Cloud seal、发布、发布后
  下载复核与 live Fresh/Resume 黑盒 A～F 尚待完成；
