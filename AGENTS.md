...
| 已完成迁移设计 | `docs/beta2-slim-repository-m2-transformation-plan.md` | M2 的 59-path、覆盖、orphan worktree、版本、分批和回滚证据 |
| 已完成迁移证据 | successor 的 `docs/beta3-dev-m4-cutover-plan.md` 与活动 planning | M4 public main、default/protection、archive navigation 与 rollback 验收；本归档仓库只保留交接摘要，后续源码权威是 successor `main` |
