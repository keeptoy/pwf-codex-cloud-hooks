...
readonly HOOKS_VERSION="${HOOKS_VERSION:-v0.2.1}"
...
readonly HOOKS_SHA256="${HOOKS_SHA256:-307ad804153a64a57cbeae7690d41e483f94ad9cde64c0d101f43caaf1ca04e2}"
...
Commands:
  ...
  hooks          Install, doctor, and verify Managed Hooks; requires Node.js and the Skill.
  verify         Verify the installed Skill and Managed Hooks without installing anything.
  help           Show this help.
